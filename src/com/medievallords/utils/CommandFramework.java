...
public class CommandFramework implements CommandExecutor {
     ...
     */
    public CommandFramework(Dungeons plugin) {
        this.plugin = plugin;
    ...
    /**
     * Handles com.mccritz.kperms.commands. Used in the onCommand method in your JavaPlugin class
     *
        ...
        for (int i = args.length; i >= 0; i--) {
            ...
            if (commandMap.containsKey(cmdLabel)) {
                ...
                if (!command.permission().equals("") && !sender.hasPermission(command.permission())) {
                    MessageManager.sendMessage(sender, command.noPerm());
                    return true;
                }

                if (command.inGameOnly() && !(sender instanceof Player)) {
                    MessageManager.sendMessage(sender, "&cThis command is only performable in game.");
                    return true;
                }
     ...
     *
     * @param obj The object to register the com.mccritz.kperms.commands of
     */
    ...
    /**
     * Registers all the com.mccritz.kperms.commands under the plugin's help
     */
    public void registerHelp() {
        ...
        IndexHelpTopic topic = new IndexHelpTopic(plugin.getName(), "All com.mccritz.kperms.commands for " + plugin.getName(), null, help, "Below is a list of all " + plugin.getName() + " com.mccritz.kperms.commands:");
